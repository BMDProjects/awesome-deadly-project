...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    private float looking[] = new float[3];
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        */
        ...
        cameraFollow(x, y , 0.5f);

        // Set the camera position (View matrix)
        //Matrix.setLookAtM(mViewMatrix, 0, 0, 0, mZoom, 0f, 0f, 0f, 0f, 2.0f, 0.0f);
        Matrix.setLookAtM(mViewMatrix, 0, eyePos[0], eyePos[1], eyePos[2], looking[0], looking[1], looking[2], 0f, 2.0f, 0.0f);
    ...
    public void cameraFollow(float x, float y, float z) {
