...
public class Nchar {
    ...
    static float squareCoords[] = {
            ...
            -0.90f, -1.0f, 0.0f,   // bottom right 2
            -0.90f,  1.0f, 0.0f,  // top right 3
            -0.75f, 1.0f, 0.0f, // Jut 4
            -0.5f, -1.0f,  0.0f, //2nd bottomL 5
            -0.5f,  1.0f,  0.0f, //2nd topL 6
            -0.4f, 1.0f,  0.0f, //2nd topR 7
            -0.4f,   -1.0f, 0.0f,//2nd bottomR 8
    ...
    private final short drawOrder[] = { 0, 1, 2, 0, 2, 3, 0, 3, 5, 3, 5, 8, 5, 6, 7, 5, 7, 8}; //, 0, 2, 5, 2, 5, 8, 5, 6, 7, 5, 8, 7}; // order to draw vertices
